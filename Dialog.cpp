...
Dialog::Dialog(const char *font_path, const glm::u8vec4 &background_color, const glm::vec4 &bounding_box, FT_F26Dot6 font_size, const glm::u8vec4 &font_color) : font_size_(font_size),
...
MenuDialog::MenuDialog(const char *font_path, const glm::u8vec4 &background_color, const glm::vec4 &bounding_box, FT_F26Dot6 font_size, const glm::u8vec4 &font_color,
					   int max_choice, const glm::u8vec4 &current_choice_color, int current_choice) : Dialog(font_path, background_color, bounding_box, font_size, font_color),
